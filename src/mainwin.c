...
void mw_create(gint da_width, gint da_height) {
    ...
    "/gtkballs/gtkballs_16x16.png", &error);
    if (icon) {
    ...
    gtk_widget_set_events(_drawing_area,
                          GDK_EXPOSURE_MASK | GDK_BUTTON_PRESS_MASK | GDK_KEY_PRESS_MASK | GDK_POINTER_MOTION_MASK);
